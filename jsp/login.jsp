...
<aos:body class2="bodyclass">
	<div id="north_el" class="x-hidden north_el">
		<table>
			<tr>
				<td align="left" width="360"><img src="${cxt}/static/image/logo/logo-unicom.png"></td>
			</tr>
		</table>
	</div>
					...
					.ajax({
						...
						ok : function(data) {
							if (data.appcode === '1') {
								...
								fn_login_success();
								document.write("<form action='do.jhtml?router=homeService.initIndex' method='post' name='form1' style='display:none'>");
								  document.write("<input type='hidden' name='juid' value='"+data.juid+"'>");
								  document.write("</form>");
