                ...
                <tr>
                    <td height="16" valign="middle" class="MainRightTab_td1"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                        <tr class="font_weight">
                            <td width="25%" align="center">身份证实名认证</td>
...
<script>
    function DisplayQRAndData() {
    	var url = "/aos/getQRCode/idQRCode.do";
    	var params = {};
	    ...
	    params.returnUrl = "101.71.143.136:9000/aos/NetCallBack/idback";
	    params.memberId = "";
...
/* 				document.getElementById("qrcode").value = qrCodeStr;
		...
		var timeout = setInterval(function () {
	          ...
	          $.ajax({
	              type: "POST",
	              url: "/aos/listenStatus/idlisten.do",
	              dataType: "json",
