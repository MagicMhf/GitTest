                ...
                <tr>
                    <td height="16" valign="middle" class="MainRightTab_td1"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                        <tr class="font_weight">
                            <td width="25%" align="center">三要素核验</td>
...
<script>
    function DisplayQRAndData() {
    	var url = "/aos/getQRCode/fixedQRCode.do";
    	var params = {};
	    ...
	    params.returnUrl = "101.71.143.136:9000/aos/NetCallBack/back";
	    params.memberId = "";
	    params.userid = $("#userid").val();
	    params.usenum = ${cishu};
	    params.itfcname = "三要素详版";
...
/* 				document.getElementById("qrcode").value = qrCodeStr;
		...
		var timeout = setInterval(function () {
	          ...
	          $.ajax({
	              type: "POST",
	              url: "/aos/listenStatus/listen.do",
	              dataType: "json",
