...
<aos:html title="黑名单详情" base="http" lib="ext,jquery">
<head>
    ...
    <%--<table width="95%" border="0" cellspacing="0" cellpadding="0" class="left">
        <tr>
            <td><span class="reder">当前位置：</span><a href="main1.html" target="mainFrame">首页</a>> 黑名单验证 </td>
        </tr>
    </table>--%>
    <br>
    <table width="95%" border="0" cellspacing="0" cellpadding="0" class="left">
        <tr>
            <td width="18%" rowspan="3" ><div align="center"><img src="${cxt}/static/image/unicom/detail_black.jpg" width="170" height="170"></div></td>
            <td colspan="2" valign="top" ><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td width="2%">&nbsp;</td>
                    <td width="98%"><p><b>黑名单核验</b></p>
                        <p> 提供法院失信名单、被执行人名单、互金逾期名单、羊毛党等黑名单类数据。</p></td>
                </tr>
            </table>
            </td>
                                ...
                                <td width="19%" height="32" align="right" class="MainRightTab_td1"><div align="left"></div>
                                    <table width="100%" height="18" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            ...
                                            <td width="95%" >
                                                <span style="color:#FF0000;font-weight:bold;" id="price">350</span>
                                        ...
                                        <td width="95%" ><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <form name="form1" method="post" action="">
                                                    <td>
                                                        <input type="radio" name="radiobutton" value="100" onclick="modPrice('350')" checked><b>100次≈3.50元/次</b>
                                                    </td>
                                                    <td>
                                                        <input type="radio" name="radiobutton" value="1000" onclick="modPrice('3200')"><b>1000次≈3.20元/次</b>
                                                    </td>
                                                    <td>
                                                        <input type="radio" name="radiobutton" value="10000" onclick="modPrice('28000')"><b>1万次≈2.80元/次</b>
                                                    </td>
                                                    <td>
                                                        <input type="radio" name="radiobutton" value="50000" onclick="modPrice('125000')"><b>5万次≈2.50元/次</b>
                                                    </td>
                                                    <td>
                                                        <input type="radio" name="radiobutton" value="100000" onclick="modPrice('200000')"><b>10万次≈2.00元/次</b>
                                                    </td>
                                                </form>
                                            </tr>
                                        </table></td>
        ...
        <tr>
            ...
            <td width="69%" ><table width="450"  border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    <td width="150">
                        <a href="javascript:void(0);" onclick="fnaddtab('mainService.initPayment5','支付确认','payment5')">
                        <%--<a href="buy1.html" target="mainFrame" >--%><button class="golistbutton button1">购买</button></a>
                    </td>
                    <td width="150">
                    	<a href="javascript:void(0);" onclick="fnaddtab('mainService.initBlackTryout','试用','tryout')">
                    		<button class="golistbutton button2">试用</button></a></td>
                    <td width="150">
                        <a href="javascript:void(0);" onclick="fnaddtab('mainService.initBlackInvoke','数据调用','dataInvoke')" >
...
<!--                     <li class="">评论</li> -->
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="MainRightTab_bg1">
                                    <tr>
                                        <td width="19%" align="right" class="MainRightTab_td1">
                                            ...
                                            <p align="left">通过API接口接入，入参三要素，进而识别出是否有法院以及金融的逾期风险</p>
                                            <p align="left"><b>应用场景：</b></p>
                                            <p align="left"> 涵盖了从注册、信息核验、准入、信用评估、放款等多个环节，帮助客户尽早的发现潜在的欺诈风险。</p>
                                            <p align="left"><b>计费方式：</b>查得付费</p>
                                            <p align="left"><b>量级及覆盖范围：</b></p>
                                            <p align="left">提供法院失信名单、被执行人名单、互金逾期名单、羊毛党等风险名单类数据。</p>
                                    </tr>
                                </table>
                                </td>
                            </tr>
                    ...
                    <tr>
                        ...
                        <tbody width="19%" align="left" class="MainRightTab_td1">
                            ...
                            <tr>
                                <td>customSource</td>
                                <td>int</td>
                                <td>A:小号；B:验证码接受平台；C:电商欺诈号；D:互联网金融</td>
                                <td>黑名单来源</td>
                            </tr>
                            <tr>
                                <td>error_code</td>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
    		...
    		$.ajax({
    			type : "post",
    			url : '/aos/http/do.jhtml?router=mainService.kkblack&juid=${juid}',
    			data : {},
    			dataType: "json",
...
<script>
    ...
    function fnaddtab(url, menuname, module_id) {
    	if(url=='mainService.initPayment5'){
