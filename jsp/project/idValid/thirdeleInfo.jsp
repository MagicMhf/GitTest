...
<head>
    ...
    <%--<table width="95%" border="0" cellspacing="0" cellpadding="0" class="left">
        <tr>
            <td><span class="reder">当前位置：</span><a href="main1.html" target="mainFrame">首页</a>> 三要素验证 </td>
        </tr>
    </table>--%>
    <br>
    <table width="95%" border="0" cellspacing="0" cellpadding="0" class="left">
        <tr>
            <td width="18%" rowspan="3" ><div align="center"><img src="${cxt}/static/image/unicom/detail_tempInfoPic.jpg" width="170" height="170"></div></td>
            <td colspan="2" valign="top" ><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td width="2%">&nbsp;</td>
                    <td width="98%"><p><b>三要素核验</b></p>
                                ...
                                <td width="19%" height="32" align="right" class="MainRightTab_td1"><div align="left"></div>
                                    <table width="100%" height="18" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            ...
                                            <td width="95%" >
                                                <span style="color:#FF0000;font-weight:bold;" id="price">120</span>
                                        ...
                                        <td width="95%" ><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <form name="form1" method="post" action="">
                                                    <td>
                                                        <input type="radio" name="radiobutton" value="100" onclick="modPrice('120')" checked><b>100次≈1.20元/次</b>
                                                    </td>
                                                    <td>
                                                        <input type="radio" name="radiobutton" value="1000" onclick="modPrice('1000')"><b>1000次≈1.00元/次</b>
                                                    </td>
                                                    <td>
                                                        <input type="radio" name="radiobutton" value="10000" onclick="modPrice('8000')"><b>1万次≈0.80元/次</b>
                                                    </td>
                                                    <td>
                                                        <input type="radio" name="radiobutton" value="50000" onclick="modPrice('34000')"><b>5万次≈0.68元/次</b>
                                                    </td>
                                                    <td>
        ...
        <tr>
            ...
            <td width="69%" ><table width="450"  border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    <td width="150">
                        <a href="javascript:void(0);" onclick="fnaddtab('mainService.initPayment2','支付确认','payment2')">
                        <%--<a href="buy1.html" target="mainFrame" >--%><button class="golistbutton button1">购买</button></a>
                    </td>
                    <td width="150">
                    	<a href="javascript:void(0);" onclick="fnaddtab('mainService.initTryout','试用','tryout')">
                    		<button class="golistbutton button2">试用</button></a></td>
                    <td width="150">
                        <a href="javascript:void(0);" onclick="fnaddtab('mainService.initInvoke','数据调用','dataInvoke')" >
                    ...
                    <tr>
                        ...
                        <tbody width="19%" align="left" class="MainRightTab_td1">
                            ...
                            <tr>
                                <td>rescode</td>
                                <td>String</td>
                                <td>11:匹配，21：姓名不匹配，22：身份证不匹配，23：姓名身份证均不匹配；24：不匹配，具体要素不匹配未知</td>
                                <td>匹配详情码</td>
                            </tr>
                            <tr>
                                <td>　</td>
                                <td>　</td>
                                <td>23：姓名身份证均不匹配；24：不匹配，具体要素不匹配未知</td>
                                <td>　</td>
                            </tr>
                            <tr>
                                <td>error_code</td>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
    		...
    		$.ajax({
    			type : "post",
    			url : '/aos/http/do.jhtml?router=mainService.kk&juid=${juid}',
    			data : {},
    			dataType: "json",
...
<script>
    ...
    function fnaddtab(url, menuname, module_id) {
    	if(url=='mainService.initPayment2'){
